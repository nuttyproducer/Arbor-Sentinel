...
This file is the human-readable companion to `src/data/attributions.ts`, which is the canonical data source. Every image used on the site is recorded in both files.
...
**Status:** `review_pending` — the exact Wikimedia Commons file URL has not yet been confirmed. The author, license, and title are recorded from the original file metadata.

**Title:** Forced Displacement of Gaza Strip Residents During the Gaza-Israel War 23-25
...
**Source:** [Flickr / Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Destruction_of_Gaza_1.jpg)
