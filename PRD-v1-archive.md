# Accountability Atlas — Product Requirements Document (PRD) — ARCHIVED

> **⚠️ ARCHIVED DOCUMENT — July 2026**
>
> This document has been superseded by **[PRD-v2.md](PRD-v2.md)** — the canonical Product Requirements Document rebuilt around the intelligence pipeline architecture (Sources → Collection → Normalization → AI Intelligence → Human Review → Publication → Public Platform → Action → Impact).
>
> This archive is preserved for reference. It contains detailed page specifications, SQL schemas, risk register, sprint plans, and other material not duplicated in the V2 PRD. Consult **[PRD-v2.md](PRD-v2.md)** for current product requirements, then reference this archive for implementation-level detail.
>
> Also see: **[AI-INTELLIGENCE-PRD.md](AI-INTELLIGENCE-PRD.md)** for the complete AI/collector/review/maps/graph specification (supersedes `AI_Intelligence_Architecture_Addendum.md`).

ALSO READ AI_Intelligence_Architecture_Addendum.md as this is the main AI PRD document!
